...
function NosePin2() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "nosePin2",
      name: "Flowerbud Nosering",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwe4bd42f3/images/hi-res/500063OCAAAC02_2.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold mt-5">Flowerbud Nosering</h2>
        ...
        <div className="prices mt-5">
          <span>
            ...
            <del className="text-decoration-none font-medium text-xl">
              <span className="strike-through list ml-2">
                <label> Price</label>
