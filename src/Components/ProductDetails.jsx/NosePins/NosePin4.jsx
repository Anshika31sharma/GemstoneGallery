...
function NosePin4() {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      name: "Kundan Nosepin",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwa65fe344/images/hi-res/511619OBEAAAP3_1.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl mt-2 font-bold">Kundan Nosepin</h2>
