...
function NosePin1() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "nosePin1",
      name: "Classic Radiant Gold Nath",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw7c51ff96/images/hi-res/513817OAAAAAP3_1.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold mt-5">Classic Radiant Gold Nath</h2>
        ...
        <div className="prices mt-5">
          ...
          <div className="col-12 mt-5">
            <ul className="list-group text-xl">
