...
function NosePin3() {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      name: "Peacock Nath",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwa3172804/images/hi-res/513020OKJAAAP1_1.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold mt-5">Peacock Nath</h2>
