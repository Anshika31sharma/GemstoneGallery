...
function Chain1() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "chain1",
      name: "Abstract Gold Chain",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw3083dc61/images/hi-res/504025CIKAA00_2.jpg",
    });
    setItemAdded(true);
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center">
      <div>
        <img
          ...
          alt="Abstract Gold Chain"
        />
      </div>
      <div className="md:ml-10 md:mt-10 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl mt-5 font-bold">Abstract Gold Chain</h2>
        <div className="col-sm-12 text-base md:text-lg mt-3 md:mt-5 col-md-8 col-lg-12 pt-2 value content px-0 pt-lg-0">
          Mesmerising abstract patterns come together to form this glamorous tassel chain crafted in 18 karat yellow gold.
        </div>
