...
function Chain2() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "chain2",
      name: "Swirls Orbs Chain",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw5df35328/images/hi-res/504025CZDAA00_2.jpg",
    });
    setItemAdded(true);
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center">
      <div>
        <img
          ...
          alt="Swirls Orbs Chain"
        />
      </div>
      <div className="md:ml-10 md:mt-10 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl mt-5 font-bold">Swirls Orbs Chain</h2>
