...
function Pendant4() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "pendant4",
      name: "Ritzy Radiant Pendant",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwd7c0cf4c/images/hi-res/50D3I1PSAAAA02_2.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold">Ritzy Radiant Pendant</h2>
