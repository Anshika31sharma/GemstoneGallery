...
function Pendant2() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "pendant2",
      name: "Swirls Diamond Pendant",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwd3e19672/images/hi-res/506060PKLAAA02_2.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold">Swirls Diamond Pendant</h2>
