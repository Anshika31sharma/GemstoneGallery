...
function Pendant1() {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwd177ab4b/images/hi-res/50D3I1PRRAAA29_2.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold">Pearl and Diamond Pendant</h2>
          ...
          <span>
            <span className="sales font-bold text-4xl">
              <span className="value price-text evgProductPrice " content="36,449">
                ...
                <span className=" ml-3">₹32,048</span>
              </span>
            </span>
