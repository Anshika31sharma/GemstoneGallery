...
function Fingerring4() {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwf26a06cb/images/hi-res/50D2D2FVXAA02_1.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      <div>
        <img
          className="d-block img-fluid aspect-ratio open-image-swiper h-96 w-96 md:ml-10 md:mt-10"
          id="myimage"
          ...
          <span>
            <span className="sales font-bold text-4xl">
              <span className="value price-text evgProductPrice " content="36,449">
                ...
                <span className=" ml-3">₹23,868</span>
              </span>
            </span>
