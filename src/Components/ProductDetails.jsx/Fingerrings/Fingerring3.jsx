...
function Fingerring3() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "fingerring3",
      name: "Stackable Arch Diamond Ring",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw37a9ecf2/images/hi-res/50D2CAFCI3A09_1.jpg"
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div>
        <img
          className="d-block shadow-lg img-fluid aspect-ratio open-image-swiper h-64 w-64 ml-10 mt-10"
          id="myimage"
      ...
      <div className="ml-10 mt-10 md:ml-20">
        <h2 className="text-2xl font-bold">Stackable Arch Diamond Ring</h2>
