...
function Earring4() {
  ...
  return (
    <div className="flex">
      <div>
      <img class="d-block img-fluid aspect-ratio open-image-swiper h-96 w-96 ml-10 mt-10" id="myimage" src="https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw40c38f79/images/hi-res/50LB21DAKABA34_1.jpg?sw=640&sh=640" width="100%" height="100%" onerror="this.src='/on/demandware.static/-/Sites-Tanishq-site-catalog/default/v7e4151d8817101406b98615b73a8da6b6467c4c1/noimage/medium_missing.svg'" image-index="0" alt="Sophisticated Dainty Diamond Drop Earrings,,hi-res image number null" hi-res-url="https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw58eb627c/images/hi-res/50D2FFDMKAGA09_1.jpg" itemprop="image"/>
     
      </div>
      <div className=" ml-20 mt-10">
        <h2 className="text-2xl font-bold"> The Lightness of Being</h2>
