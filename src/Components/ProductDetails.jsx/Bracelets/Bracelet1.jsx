...
function Bracelet1() {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw8b6a880c/images/hi-res/50D3B2BUMAA02_2.jpg",
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      ...
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl  mt-5 font-bold">Flower Diamond Bracelet</h2>
