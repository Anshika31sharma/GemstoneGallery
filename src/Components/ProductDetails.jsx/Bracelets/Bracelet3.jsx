...
function Bracelet3() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "bracelet3",
      name: "Graceful Stamp Bracelet",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwa80bf5cf/images/hi-res/51D3B2BBRAA00_2.jpg",
    });
    setItemAdded(true);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      <div>
        <img
          className="d-block shadow-lg img-fluid aspect-ratio open-image-swiper  h-96 md:w-96 md:ml-10 md:mt-10"
          id="myimage"
      ...
      <div className="md:ml-10 md:mt-10 text-center md:text-left">
        <h2 className="text-3xl font-bold">Graceful Stamp Bracelet</h2>
        ...
        <div className="prices mt-5">
          ...
          <div className="row cart-and-ipay flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-5 mt-5">
            <div className="col-12  button-add">
              <input
                type="hidden"
            ...
            <div className="col-12  button-buy">
              <input
                type="hidden"
                className="add-to-cart-url"
                value="/on/demandware.store/Sites-Tanishq-Site/en_IN/Cart-AddProduct"
