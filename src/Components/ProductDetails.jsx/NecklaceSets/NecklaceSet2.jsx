...
function Necklaceset2() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "necklaceset2",
      name: "Lotus Necklace Set",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw3756e376/images/hi-res/51D3B42MQABAP3_2.jpg"
    });
    setItemAdded(true);
    ...
    <div className="flex flex-col md:flex-row items-center">
      <div>
        <img
          ...
          alt="Lotus Necklace Set"
        />
      </div>
      <div className="md:ml-20 md:mt-10">
        <h2 className="text-3xl font-bold">Lotus Necklace Set</h2>
