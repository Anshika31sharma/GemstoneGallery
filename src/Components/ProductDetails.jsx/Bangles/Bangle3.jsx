...
function Bangle3() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "bangle3",
      name: "Nature Inspired Bangle",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw72f3a6be/images/hi-res/51D3B2VAX2A00_2.jpg",
    });
    setItemAdded(true);
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center">
      <div>
        <img
          ...
          alt="Nature Inspired Bangle"
        />
      </div>
      <div className="md:ml-10 md:mt-10 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl mt-5 font-bold">Nature Inspired Bangle</h2>
