...
function Bangle2() {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: "bangle2",
      name: "Classic Ethnic Bangle",
      price: 36449,
      image: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw24f2c6b9/images/hi-res/51D3A1VSH2A00_2.jpg",
    });
    setItemAdded(true);
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center">
      <div>
        <img
          ...
          alt="Classic Ethnic Bangle"
        />
      </div>
      <div className="md:ml-10 md:mt-10 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl mt-5 font-bold">Classic Ethnic Bangle</h2>
